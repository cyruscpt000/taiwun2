...
export const INITIAL_PACKING_LIST: PackingItem[] = [
  ...
  { id: 'p17', name: 'passport / 入台證', completed: false, assignedTo: '大哥' },
...
export const DEFAULT_ITINERARY: ItineraryItem[] = [
  ...
  // Day 2 (12/31)
  { id: 'day2-1', time: '09:00', type: 'FOOD', title: '阜杭豆漿', location: '台北市中正區忠孝東路一段108號2樓', day: 2 },
  { id: 'day2-2', time: '10:30', type: 'SIGHT', title: '買手信：犁記?', location: '台北市中山區長安東路二段67號', day: 2 },
  { id: 'day2-3', time: '12:30', type: 'FOOD', title: '黑武士特色老火鍋 (booked 12:30)', subtitle: '台北信義新天地A9店-6F', location: '台北市信義區松壽路9號6樓', day: 2 },
  ...
  { id: 'day2-6', time: '21:00', type: 'SIGHT', title: '饒河夜市 🎆', location: '台北市松山區饒河街', day: 2 },
  ...
  { id: 'day3-4', time: '16:00', type: 'TRANSPORT', title: '回宜蘭轉運站', subtitle: '搭葛瑪蘭客運去「科技大樓站」落', day: 3 },
  { id: 'day3-5', time: '19:00', type: 'SIGHT', title: '臨江街觀光夜市 (通化夜市)', location: '台北市大安區臨江街', day: 3 },
  ...
  { id: 'day4-5', time: '20:00', type: 'FOOD', title: '無老鍋火鍋 (Booked)', subtitle: '台北中山店', location: '台北市中山區中山北路二段36-1號', day: 4 },
